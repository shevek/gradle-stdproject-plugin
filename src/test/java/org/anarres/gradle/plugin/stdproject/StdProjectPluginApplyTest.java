...
public class StdProjectPluginApplyTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(StdProjectPluginApplyTest.class);
    ...
    public StdProjectPluginApplyTest(String gradleVersion) {
        this.gradleVersion = gradleVersion;
    }

    @Test
    public void testApply() throws Exception {
        String text = "plugins { id 'org.anarres.stdproject' }\n"
                + "stdproject {}\n";
